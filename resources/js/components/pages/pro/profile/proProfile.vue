              ...
              <div class="table-responsive p-0" style="padding: 5px !important;">
                ...
                <div v-else>
                  ...
                  <div class="profile_settings_div">
                    <router-link class="btn btn-outline-primary btn-sm mb-0 me-3" style="display: flex; justify-content: center; align-items: center; width: 165px; height: 52px; margin: 5px !important; padding: 5px;" :to="{name: 'proChangeEmail'}">Change Email</router-link>
                    <router-link class="btn btn-outline-primary btn-sm mb-0 me-3" style="display: flex; justify-content: center; align-items: center; width: 165px; height: 52px; margin: 5px !important; padding: 5px;" :to="{name: 'proChangePassword'}">Change Password</router-link>
                    <router-link class="btn btn-outline-primary btn-sm mb-0 me-3" style="display: flex; justify-content: center; align-items: center; width: 165px; height: 52px; margin: 5px !important; padding: 5px;" :to="{name: 'proChangePicture'}">Change Profile Picture</router-link>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="nav-wrapper position-relative end-0">
                    <div style="display: flex; justify-content: center; align-items: center;">
                      <div class="social_tabs">
                        <a id="facebook_tab" href="/pro-profile/show-facebook-tab" class="social_tabs_links" style="background-color: #ffffff; box-shadow: 0 1px 5px 1px #ddd;" @click.prevent="switchFacebookTab">
                          <i class="fa fa-facebook-f"></i>
                        </a>
                      </div>
                      <div class="social_tabs">
                        <a id="github_tab" href="/pro-profile/show-github-tab" class="social_tabs_links" style="background-color: #F8F9FA; box-shadow: none" @click.prevent="switchGithubTab">
                          <i class="fa fa-github"></i>
                        </a>
                      </div>
                      <div class="social_tabs">
                        <a id="google_tab" href="/pro-profile/show-google-tab" class="social_tabs_links" style="background-color: #F8F9FA; box-shadow: none;" @click.prevent="switchGoogleTab">
  ...
  export default{
    ...
    setup(){
      ...
      const facebookConnectUser = async() => {
        const type_profile = 'pro-profile'
